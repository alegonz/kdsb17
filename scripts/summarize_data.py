...
# BASE_PATH = '/sandbox/data_science_bowl_2007/sample_images/'
...
header_file = '/sandbox/data_science_bowl_2007/analysis/header.csv'
...
# Gather data
csv_file = open('/sandbox/data_science_bowl_2007/analysis/stage1_data_summary.csv', 'a')
...
for p, patient_folder in enumerate(os.listdir(BASE_PATH), start=1):
    ...
    print('Patient %s done - %d files - %d - %s - %s - %.3f' % (patient_folder, len(dcm_files), n, proc_time, total_time, (t2-t0)/n))
